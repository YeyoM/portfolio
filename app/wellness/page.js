    ...
    <main className="bg-[#FBF6ED] min-h-screen">
      ...
      <div className="mx-auto flex flex-col items-center justify-center">
        <div className="flex flex-col w-[90%] max-w-[680px] mt-40 mb-24">
          ...
          <p className="text-md font-normal text-black text-justify">
            <span className="font-semibold">Tools:</span> Git, GitHub, Firebase, FIrestore, Expo
          </p>
          <p className="text-md font-normal text-black text-justify">
          ...
          <p className="text-md font-normal text-black text-justify">
            You can check out the code on my GitHub <a className="text-[#2292BF] hover:underline" href="https://github.com/YeyoM/wellness-mobile-app" target="_blank">here</a>.
